    ...
    return (
        <div className='max-w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
            <div className='p-4 space-y-3 rounded-2xl bg-white shadow-xl hover:scale-105 transition duration-500 hover:bg-blue-200'>
                ...
                <h2 className='text-center text-2xl font-bold text-black'>Create Account</h2>
                <p className='text-gray-400 font-semibold text-center mb-15 text-black'>Sign up for free in seconds. No credit card required to get started.</p>
            </div>
            <div className='p-4 space-y-3 rounded-2xl bg-white shadow-xl hover:scale-105 transition duration-500 hover:bg-blue-200'>
                <div className='flex justify-end'>
                ...
                <h2 className='text-center text-2xl font-bold text-black'>Choose Products</h2>
            ...
            <div className='p-4 space-y-3 rounded-2xl bg-white shadow-xl hover:scale-105 transition duration-500 hover:bg-blue-200'>
                ...
                <h2 className='text-center text-2xl font-bold text-black'>Start Creating</h2>
