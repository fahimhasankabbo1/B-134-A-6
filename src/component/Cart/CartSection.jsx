...
const CartSection = ({p,g}) => {
    ...
    return (
        <div className='flex justify-between items-center flex-col lg:flex-row text-center lg:text-left gap-3 lg:gap-0 p-4 bg-black rounded-2xl border border-gray-300 hover:border-red-500'>
